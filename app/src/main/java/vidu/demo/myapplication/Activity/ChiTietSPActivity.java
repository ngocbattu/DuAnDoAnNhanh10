...
public class ChiTietSPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = intent.getIntExtra ("id",0);
         AnhSP = intent.getStringExtra ("anhSP");
         TenSP = intent.getStringExtra ("tenSP");
         GiaSP = intent.getIntExtra ("giaSP",0);
    ...
    public void Init(){
        ...
        edt_so_luong = findViewById (R.id.edt_so_luong_sp);
    }
    @Override
                ...
                databaseReference.child (String.valueOf (idsp)).addValueEventListener (new ValueEventListener () {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(edt_so_luong.getText ().toString ().equals ("")){
                            Toast.makeText (ChiTietSPActivity.this, "Vui lòng nhập số lượng", Toast.LENGTH_SHORT).show ();
                            return;
                        }
                        ...
                        HangDaChonFragment hangDaChonFragment = new HangDaChonFragment ();
                        finish ();
                    }
